...
type Props = Omit<MediaTileProps, 'media'> & {
  game: Game
  displayType?: Game['gameTileDisplayType']
}
...
const GameTile = ({
  ...
  const tileMedia: TileMedia = (() => {
    const displayType =
      displayTypeFromProps ?? game.gameTileDisplayType ?? DefaultGameDisplayType.gameTile
  ...
  return <MediaTile media={tileMedia} aspectRatio={aspectRatio} {...props} />
}
